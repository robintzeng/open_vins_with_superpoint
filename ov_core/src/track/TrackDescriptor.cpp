...
void TrackDescriptor::perform_detection_monocular(const cv::Mat& img0, std::vector<cv::KeyPoint>& pts0,
    ...
    std::vector<cv::KeyPoint> pts0_ext;
    cv::Mat desc0_ext;
    this->sp0.compute(img0,pts0_ext, desc0_ext,this->spn.sess);
...
void TrackDescriptor::perform_detection_stereo(const cv::Mat &img0, const cv::Mat &img1,
    ...
    std::thread t_desc0 = std::thread([this,&img0,&pts0_ext,&desc0_ext]{this->sp0.compute(img0, pts0_ext, desc0_ext,this->spn.sess);});
    std::thread t_desc1 = std::thread([this,&img1,&pts1_ext,&desc1_ext]{this->sp1.compute(img1, pts1_ext, desc1_ext,this->spn.sess);});
