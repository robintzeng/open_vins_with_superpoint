...
int main(int argc, char** argv)
{
    ...
    std::string topic_gt_odom;
    std::string topic_gt_pose;
    nh.param<std::string>("topic_imu", topic_imu, "/dvs/imu");
    nh.param<std::string>("topic_camera0", topic_camera0, "/dvs/image_raw");
    nh.param<std::string>("topic_gt_odom", topic_gt_odom, "/groundtruth/odometry");
    nh.param<std::string>("topic_gt_pose", topic_gt_pose, "/groundtruth/pose");
